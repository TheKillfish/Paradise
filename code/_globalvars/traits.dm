...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_TRECHODRONE_ADAPTED" = TRAIT_TRECHODRONE_ADAPTED,
		...
		"TRAIT_WEAK_TABLE_LEAP" = TRAIT_WEAK_TABLE_LEAP,
		"TRAIT_MID_TABLE_LEAP" = TRAIT_MID_TABLE_LEAP,
		"TRAIT_TOTAL_HEARING_PROTECTION" = TRAIT_TOTAL_HEARING_PROTECTION,
		"TRAIT_MAJOR_HEARING_PROTECTION" = TRAIT_MAJOR_HEARING_PROTECTION,
		"TRAIT_MINOR_HEARING_PROTECTION" = TRAIT_MINOR_HEARING_PROTECTION,
		"TRAIT_PRESSURE_PROOF" = TRAIT_PRESSURE_PROOF,
		"TRAIT_ACID_PROOF" = TRAIT_ACID_PROOF,
	),
