...
/datum/reagent/medicine/haloperidol
	...
	harmless = FALSE
	var/list/drug_list = list("crank", "methamphetamine", "space_drugs", "synaptizine", "psilocybin", "ephedrine", "epinephrine", "stimulants", "stimulative_agent", "bath_salts", "lsd", "thc", "mephedrone", "trechodrone", "pump_up")
	goal_difficulty = REAGENT_GOAL_NORMAL
...
/datum/reagent/medicine/nanocalcium
	...
	var/list/stimulant_list = list("methamphetamine", "crank", "bath_salts", "stimulative_agent", "stimulants", "mephedrone", "trechodrone", "ultralube", "surge", "surge_plus", "combatlube", "pump_up")
